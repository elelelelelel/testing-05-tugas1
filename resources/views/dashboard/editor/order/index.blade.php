        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <a class="btn btn-primary" href="{{ route('dashboard.editor.order.create') }}">Buat Pesanan</a>
                </div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            var current_table_url = '{{ route('ajax.dashboard.editor.order.index') }}';
            var testimonials = $('#table-1').DataTable({
                ...
                columns: [
                    ...
                    {data: '_created_at', name: '_created_at',},
