                                ...
                                <div class="text-md-right">
                                    @if($order->status == 'Menunggu Konfirmasi')
                                        <button
                                            ...
                                            class="btn btn-success btn-icon icon-left">Konfirmasi Pesanan
                                        </button>
                                        <button
                                            data-toggle="modal" data-target="#declineModal"
                                            class="btn btn-danger btn-icon icon-left">Batalkan Pesanan
                                        </button>
                                    @elseif($order->status == 'Menunggu Tawaran')
                                        <button
                                            data-toggle="modal" data-target="#refundModal"
                                            class="btn btn-danger btn-icon icon-left">Refund Pesanan
                                        </button>
                                    @endif
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Apakah anda yakin akan mengkofirmasi pesanan ini?
                    </p>
                    <form method="POST" action="{{ route('dashboard.makelar.order.confirm') }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('dashboard.makelar.order.decline') }}"
                          id="form-decline-payment">
                        <input type="hidden" name="order_id" value="{{ $order->id }}">
                        @csrf
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                    <button type="button" class="btn btn-primary"
                            onclick="event.preventDefault(); document.getElementById('form-decline-payment').submit();">
                        Ya
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="refundModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Apakah anda yakin akan merefund pesanan ini?
                    </p>
                    <form method="POST" action="{{ route('dashboard.makelar.order.refund') }}"
                          id="form-refund-payment">
                        <input type="hidden" name="order_id" value="{{ $order->id }}">
                        @csrf
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                    <button type="button" class="btn btn-primary"
                            onclick="event.preventDefault(); document.getElementById('form-refund-payment').submit();">
                        Ya
                    </button>
                </div>
            </div>
